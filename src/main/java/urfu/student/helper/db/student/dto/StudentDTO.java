...
public record StudentDTO(String studentFio, ZoneId timeZone, StudentEntity.EducationStatus educationStatus, String academicGroup, List<CourseDto> courseDtoList) {
